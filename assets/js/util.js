            ...
            return (
                ...
                i.on("touchmove", function (t) {
                    if (null !== i.touchPosX && null !== i.touchPosY) {
                        ...
                        ((0 > i.scrollTop() && a < 0) || (o > r - 2 && o < r + 2 && a > 0)) &&
                    ...
                    "" != e.attr("id") && a.attr("id", e.attr("id") + "-polyfill-field"),
                        ...
                        a
                            .on("focus", function (t) {
                                ...
                                var e = a
                                    .parent()
                                    .find("input[name=" + a.attr("name").replace("-polyfill-field", "") + "]");
                                a.hide(), e.show().focus();
                            })
                                ...
                                switch ((a.removeClass("polyfill-placeholder"), this.type)) {
                                    ...
                                    case "password":
                                        a.val(a.attr("defaultValue")),
                                            (e = a.parent().find("input[name=" + a.attr("name") + "-polyfill-field]")),
                                            "" == a.val() ? (a.hide(), e.show()) : (a.show(), e.hide());
                                        break;
                                    case "checkbox":
                                    case "radio":
                                    ...
                                    case "textarea":
                                        a.val(a.attr("defaultValue")),
                                            "" == a.val() &&
                                                (a.addClass("polyfill-placeholder"), a.val(a.attr("placeholder")));
                                        break;
                                    default:
                                        a.val(a.attr("defaultValue"));
                                }
